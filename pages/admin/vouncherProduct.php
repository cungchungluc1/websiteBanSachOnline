                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="hidden" name="id_user"
                                                value="<?php echo htmlentities($data->id_product); ?>" />
                                    ...
                                    <table id="dataTable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a
                                                        href="../controller/delVouncherProduct.php?id=<?php echo htmlentities($item->id); ?>&id_pro=<?php echo htmlentities($_GET['id'])?>"><i
