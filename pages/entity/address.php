...
function add($id_address) {
    include "./././connection.php";
        ...
        function update($id_address) {
            include "./././connection.php";
            $sql="UPDATE `tbl_address_shipping` SET `id_address`=:id_address,`id_user`=:id_user,`diachi`=:diachi,`phuong`=:phuong,`quan`=:quan,`tinh`=:tinh,`is_defaul`=:is_defaul WHERE `id_address`=:id_address";
                $query = $dbh->prepare($sql);
