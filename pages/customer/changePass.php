            ...
            <div class="tygh-content clearfix">
                ...
                <div class="row">
                  <div class="span16">
                    <div class="hidden-phone">
                      <div id="breadcrumbs_10">
                        <div class="ty-breadcrumbs clearfix">
                          ...
                          ><a class="ty-breadcrumbs__a" >Thay đổi mật khẩu</a>
                        </div>
                        <!--breadcrumbs_10-->
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span16">
                            <form  autocomplete="off" action="../controller/changePass.php" method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col-md-1"></div>
                                    <div class="form-group col-md-4">
                                    <label for="inputEmail4">Password old</label>
                                    <input type="password" name="password_old" minlength="8" maxlength="50" value="" class="form-control" id="inputEmail4" placeholder="Enter password old" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-1"></div>
                                    ...
                                    <input type="password" name="password_new" minlength="8" maxlength="50" value="" class="form-control" id="inputEmail4" placeholder="Enter password new" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-1"></div>
                                    ...
                                    <input type="password" name="password_confirm" minlength="8" maxlength="50" value="" class="form-control" id="inputEmail4" placeholder="Enter password confirm" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-1"></div>
