                        ...
                        <div class="span16">
                            <div id="breadcrumbs_10">
                                <div class="ty-breadcrumbs clearfix">
                                    <a href="home.php" class="ty-breadcrumbs__a">Trang chủ</a>>><span
                                        class="ty-breadcrumbs__current"><bdi>Chi tiết giỏ hàng</bdi></span>
                                </div>
                                <!--breadcrumbs_10-->
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="span16 vs-cart-page et-content">
                            ...
                            <form name="checkout_form"
                                class="cm-check-changes cm-ajax cm-ajax-full-render cm-processed-form" action="#"
                                ...
                                <div class="buttons-container ty-cart-content__top-buttons clearfix">
                                    <div class="ty-float-left ty-cart-content__left-buttons">
                                        <a href="./home.php" class="ty-btn ty-btn__secondary">Tiếp tục mua hàng</a>
                                        <a class="ty-btn nobg vs-clear-cart ty-cart-content__clear-button text-button"
                                            href="../controller/deleteCart.php">Xóa giỏ hàng</a>
                                    </div>
                                    <div class="ty-float-right ty-cart-content__right-buttons">
                                        <button id="button_cart"
                                            ...
                                            type="submit" name="dispatch[checkout.update]">
                                            Tính lại
                                        </button>
                                        <a class="cm-dialog-opener cm-dialog-auto-size ty-btn ty-btn__primary" alt=""
                                            data-ca-dialog-title="Đăng nhập" data-ca-target-id="checkout_login_form"
                                            rel="nofollow">
                                            Thanh toán
                                        </a>
                                    </div>
                              ...
                              ?>
                                                <tr class="vs-cart-product">
                                                    <td
                                                        ...
                                                        <div class="ty-cart-content__image cm-reload-4160822667"
                                                            id="product_image_update_4160822667">
                                                            <a alt="">
                                                                <img class="ty-pict cm-image" id="det_img_4160822667"
                                                                    src="<?php echo "../layout/".htmlentities($dataaproduct->url); ?>"
                                                                    style="height:100px; width:auto;" data-src=""
                                                    ...
                                                    <td class="ty-cart-content__product-elem ty-cart-content__description"
                                                        style="width: 50%">
                                                        <a href="./product.php?id=<?php echo htmlentities($dataaproduct->id_product); ?>"
                                                            class="ty-cart-content__product-title"><?php echo htmlentities($dataaproduct->name); ?></a><a
                                                            class="ty-cart-content__product-delete ty-delete-big" alt=""
                                        ...
                                        $detalPc = $pc1->getapublishingCompany($dataaproduct->id_publishing_company);  ?>
                                                                        <span
                                                                            class="ty-control-group__label"><a><?php if($detalPc!=null) echo htmlentities($detalPc->name); ?></a></span>
                                                                    </div>
                                                    ...
                                                    <td class="ty-cart-content__product-elem ty-cart-content__price cm-reload-4160822667"
                                                        id="price_display_update_4160822667">
                                                        <bdi><span id="sec_product_price_4160822667"
                                                                class="ty-sub-price"><?php echo htmlentities($dataaproduct->price); ?></span>&nbsp;<span
                                                                class="ty-sub-price">đ</span></bdi>
                                                        <!--price_display_update_4160822667-->
                                                    </td>
                                                    <td class="ty-cart-content__product-elem ty-cart-content__qty">
                                                        <div class="quantity cm-reload-4160822667 changer et-qty"
                                                            ...
                                                            <div class="ty-center ty-value-changer cm-value-changer">
                                                                <form action="../controller/addCart.php" method="post">
                                                                    <input type="hidden" name="id_product"
                                                                        value="<?php echo htmlentities($item->product_id); ?>" />
                                                                    <input type="hidden" name="product_quantity"
                                                                        value="1" />
                                                                    <input type="submit"
                                                                        class="cm-increase ty-value-changer__increase text-center"
                                                                        name="submit" value="+" />
                                                                </form>

                                                                <input type="text" size="3" id="amount_4160822667"
                                                                ...
                                                                <form action="../controller/addCart.php" method="post">
                                                                    ...
                                                                    <input type="hidden" name="product_quantity"
                                                                        value="-1" />
                                                                    <button type="submit"
                                                                        class="cm-decrease ty-value-changer__decrease">-</button>
                                                                </form>
                                                    ...
                                                    <td class="ty-cart-content__product-elem ty-cart-content__price cm-reload-4160822667"
                                                        ...
                                                        <bdi><span id="sec_product_subtotal_4160822667" class="price"><?php
                                        $total += $item->quantity*$dataaproduct->price;
                                    echo htmlentities($item->quantity*$dataaproduct->price); ?></span>&nbsp;<span
                                    ...
                                    <div class="ty-coupons__container">
                                        <div>
                                            <form class="cm-ajax cm-ajax-force cm-ajax-full-render cm-processed-form"
                                                name="coupon_code_form" action="#" method="get">
                            ...
                            ?>
                                    ...
                                    <ul class="ty-cart-statistic ty-statistic-list">
                                        <li class="ty-cart-statistic__item ty-statistic-list-subtotal"> <?php 
                      $sell = 0;
                      if(isset($_GET["voucher"])){
                        include_once "../entity/vouncher.php";
                        $v1=new vouncher(); 
                        ...
                        ?>
                                            <input type="hidden" name="voucher"
                                                value="<?php echo htmlentities($set_voucher); ?>" />
                                            <span class="ty-cart-statistic__title">Giảm:
                                                <?php echo htmlentities($sell); ?></span>
                                            <?php }?>
                                            <span class="ty-cart-statistic__title">Tạm tính</span>
                                            <span class="ty-cart-statistic__value"><bdi><span><?php echo htmlentities($total); ?>
                                                    </span>&nbsp;đ</bdi></span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="ty-cart-statistic__total-list">
                                        <li class="ty-cart-statistic__item ty-cart-statistic__total">
                                            ...
                                            <span class="ty-cart-statistic__total-value">
                                                <bdi><span id="sec_cart_total"
                                                        class="ty-price"><span><?php echo htmlentities($total-$sell); ?>
                                                        </span>&nbsp;<span class="ty-price">đ</span></bdi>
                                            </span>
                                        </li>
                                    </ul>
                                    <!--checkout_totals-->
                        ...
                        if(isset($_GET["voucher"])){
                            ?>
                                        ...
                                        <?php }?>
                                        <button class="cm-dialog-opener cm-dialog-auto-size ty-btn ty-btn__primary"
                                            data-ca-dialog-title="Đăng nhập" data-ca-target-id="checkout_login_form"
                                            rel="nofollow" type="submit">
                                            Thanh toán
                                        </button>
                                    </form>
                                </div>
