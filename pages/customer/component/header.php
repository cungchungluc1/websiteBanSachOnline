                        ...
                        <div class="ty-logo-container">
                            <a href="./home.php" title="">
                                <img class="ty-pict ty-logo-container__image cm-image" id="det_img_1653948118"
                                    src="../layout/image/logoBook.png" data-src="" width="290" height="56" alt=""
                                    title="">
                            </a>
                        </div>
                    </div>
                        ...
                        if(!isset($data)){
                            ...
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    <div class="image">
                                        <img src=" <?php if($imgs!=null) echo "../layout/".htmlentities($imgs->url); else echo "../layout/image/cha15843577768538.png"; ?>"
                                    ...
                                    <div class="account-dropdown js-dropdown" style="z-index: 1000;">
                                        <div class="info clearfix">
                                            ...
                                            <div class="content">
                                                <h5 class="name">
                                                    <a
                                                        href="./profileUser.php"><?php echo htmlentities($data->name);  ?></a>
                                                </h5>
                                        ...
                                        <div class="account-dropdown__footer">
                                            <a href="../controller/logout.php"><i class="zmdi zmdi-power"></i>Đăng
                                                xuất</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="ty-menu__items cm-responsive-menu">
                            ...
                            <li class="ty-menu__item cm-menu-item-responsive">
                                <a class="ty-menu__item-toggle visible-phone visible-tablet cm-responsive-menu-toggle"><i
                                    ...
                                    href="<?php  echo "./category.php?id=".htmlentities($item->id_category); ?>"
                                    class="ty-menu__item-link"><?php echo htmlentities($item->name); ?></a>
                                ...
                                foreach ($subparent as $itemsub){ ?>
                                        <li class="ty-top-mine__submenu-col">
                                            <div class="ty-menu__submenu-item-header">
                                                <a href="<?php echo "./category.php?id=".htmlentities($itemsub->id_category); ?>"
                                                    class="ty-menu__submenu-link"><?php echo htmlentities($itemsub->name); ?></a>
                                            </div>
                                            <?php 
                                            ...
                                            <div class="ty-menu__submenu">
                                                <ul class="ty-menu__submenu-list cm-responsive-menu-submenu">
                                                    ...
                                                    <li class="ty-menu__submenu-item">
                                                        <a href="<?php echo "./category.php?id=".htmlentities($itemsub1->id_category); ?>"
                                                            class="ty-menu__submenu-link"><?php echo htmlentities($itemsub1->name); ?></a>
                                                    </li>
                                                    <?php }?>
                                                </ul>
                                            </div>
