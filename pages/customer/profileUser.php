        ...
        <div class="ty-helper-container no-touch" id="tygh_main_container">
            ...
            <div class="tygh-content clearfix">
                <div class="container">
                                ...
                                <div id="breadcrumbs_10">
                                    <div class="ty-breadcrumbs clearfix">
                                        <a href="home.php" class="ty-breadcrumbs__a">Trang chủ</a><i
                                            class="vs-icon-arrow-right"></i><a class="ty-breadcrumbs__a">profile</a>
                                    </div>
                                    <!--breadcrumbs_10-->
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="span16">
                            <form autocomplete="off" action="../controller/updateuser.php" method="POST"
                                enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">

                                            <img class="ty-pict cm-image" id="det_img_1746761672"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" value="<?php echo htmlentities($data->name); ?>"
                                            class="form-control" id="inputEmail4" placeholder="Email">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="inputEmail4">Birthday</label>
                                        <input type="date" name="birthday"
                                            value="<?php echo htmlentities($data->birthday); ?>" class="form-control"
                                        ...
                                        <div class="form-control" style="border:none;">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="sex"
                                                    ...
                                                    <?php if ($data->sex == "nam") echo htmlentities('checked="checked"');?>>
                                                <label class="form-check-label" for="inlineRadio1">nam</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="sex"
                                                    id="inlineRadio2" value="nu"
                                                    <?php if ($data->sex == "nu") echo htmlentities('checked="checked"');?>>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="phone"
                                            value="<?php echo htmlentities($data->phone); ?>" class="form-control"
                                            id="inputEmail4" placeholder="Email">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">Email</label>
                                        <input type="email" name="email"
                                            value="<?php echo htmlentities($data->email); ?>" class="form-control"
                                            id="inputEmail4" placeholder="Email">
                                    </div>
                                </div>
