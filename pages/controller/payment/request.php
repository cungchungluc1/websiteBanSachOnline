...
if (isset($_SESSION['SEAMLESS'])) {
    ...
    echo json_encode($request_fields_result);
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group padding-bot-30">
                                ...
                                <div class="col-md-8"><input type="text" class="form-control" name="card_fullname"
                                        id="card_fullname" required></div>
                            </div>
                            <?php }?>
                            <?php if ($fields['BANK_ACCOUNT']) {?>
                            <div class="form-group padding-bot-30">
                                <div class="col-md-4"><label for="card_number">Số thẻ/tài khoản</label></div>
                                <div class="col-md-8"><input type="number" class="form-control" name="card_number"
                                        id="card_number" required></div>
                            </div>
                            <?php }?>
                            <?php if ($fields['ISSUE_MONTH']) {?>
                            <div class="form-group padding-bot-30">
                                <div class="col-md-4"><label for="card_month">Tháng phát hành</label></div>
                                <div class="col-md-8"><input type="text" pattern="\d*" maxlength="2"
                                        class="form-control" name="card_month" id="card_month"
                                        placeholder="Nhập tháng phát hành: 01, 02,..." required></div>
                            </div>
                            <?php }?>
                            ...
                            <div class="form-group padding-bot-30">
                                ...
                                <div class="col-md-8"><input type="text" pattern="\d*" maxlength="2"
                                        class="form-control" name="card_year" id="card_year"
                                        placeholder="Nhập năm phát hành: 18,19,..." required></div>
                            </div>
                            <?php }?>
                            ...
                            <div class="form-group padding-bot-30">
                                ...
                                <div class="col-md-8"><input type="text" pattern="\d*" maxlength="2"
                                        class="form-control" name="card_month" id="card_month"
                                        placeholder="Nhập tháng hết hạn: 01, 02,..." required></div>
                            </div>
                            <?php }?>
                            ...
                            <div class="form-group padding-bot-30">
                                ...
                                <div class="col-md-8"><input type="text" pattern="\d*" maxlength="2"
                                        class="form-control" name="card_year" id="card_year"
                                        placeholder="Nhập năm hết hạn: 18,19,..." required></div>
                            </div>
                            <?php }?>
                            <div class="form-group padding-bot-30">
                                <div class="col-md-4"><label for="amount">Số tiền</label></div>
                                <div class="col-md-8"><input type="number" class="form-control" name="amount"
